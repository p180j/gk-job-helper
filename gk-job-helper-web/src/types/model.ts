...
export interface RecruitmentSource {id:number;sourceCode:string;sourceName:string;sourceType:string;listUrl:string;enabled:boolean;lastFetchTime:string|null;lastFetchStatus:string|null}
