...
CREATE TABLE IF NOT EXISTS recruitment_match_result (id BIGINT NOT NULL AUTO_INCREMENT,profile_id BIGINT NOT NULL,position_id BIGINT NOT NULL,match_result VARCHAR(16) NOT NULL,matched_count INT NOT NULL DEFAULT 0,uncertain_count INT NOT NULL DEFAULT 0,not_matched_count INT NOT NULL DEFAULT 0,summary VARCHAR(1000) DEFAULT NULL,created_at DATETIME DEFAULT NULL,updated_at DATETIME DEFAULT NULL,PRIMARY KEY(id),UNIQUE KEY uk_recruitment_match_profile_position(profile_id,position_id),KEY idx_recruitment_match_profile_result(profile_id,match_result));
