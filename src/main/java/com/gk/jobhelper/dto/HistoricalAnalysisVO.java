...
public class HistoricalAnalysisVO {
 private Integer examYear;private BigDecimal minInterviewScore;private BigDecimal sampleMinScore;private BigDecimal sampleMaxScore;private BigDecimal sampleMedianScore;private BigDecimal sampleAverageScore;private String comparisonLevel;private int sampleCount;private Double percentile;private String relativeLevel;private String confidence;private String comparisonDescription;private boolean available;private boolean reliable;
